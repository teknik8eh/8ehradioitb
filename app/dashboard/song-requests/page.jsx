    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        <div className="px-6 py-4 border-b border-gray-100">
          <div className="flex items-center gap-2 border border-gray-200 rounded-lg px-3 py-2 max-w-md focus-within:border-red-400 focus-within:ring-1 focus-within:ring-red-100 transition-all">
        ...
        <div className="overflow-x-auto">
          {isLoading ? (
            <div className="py-16 text-center text-gray-400 text-sm">
              <div className="w-6 h-6 border-2 border-gray-200 border-t-red-400 rounded-full animate-spin mx-auto mb-3" />
              Memuat data...
            </div>
          ) : requests.length === 0 ? (
                  ...
                  <tr key={req.id} className="hover:bg-gray-50/50 transition-colors">
                    ...
                    <td className="px-6 py-4">
                      ...
                      {req.status === "REJECTED" && req.rejectedReason && (
                        <p className="text-xs text-red-400 mt-0.5 italic">{req.rejectedReason}</p>
                      )}
                    </td>
        ...
        >
          ...
          >
            ...
            <textarea
              ...
              rows={3}
              className="w-full border border-gray-200 rounded-xl px-3 py-2 text-sm outline-none focus:border-red-400 focus:ring-2 focus:ring-red-100 resize-none"
              autoFocus
            />
